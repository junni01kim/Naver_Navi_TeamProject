...
## 사용 기술스택
프로젝트 기술 스택을 확인하려면 [다음](docs/)을 참고하세요 
## Sherpa 개요
Naver_Navi_TeamProject는 한이음ICT에서 진행하는 프로보노 멘토링 프로젝트이다.  
해당 프로젝트는 한성대학교 `2024 진로탐색학점제`, `한이음 ICT 멘토링` 프로젝트에 제출되었다.  
...
## 느낀점
팀원들의 프로젝트 느낀점을 확인하려면 [다음(추가 중)](https://github.com/KJH0506/Naver_Navi_TeamProject)을 참고하세요.

## 양식
프로젝트 간 Annotation, Pull Request, Convention 양식을 확인하고 싶다면 [다음(추가 중)](https://github.com/KJH0506/Naver_Navi_TeamProject)을 참고하세요.
